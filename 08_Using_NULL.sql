/*
Table name = teacher(id, dept,	name,	phone,	mobile)
Table name = dept(id, name)
...
SELECT name, CASE WHEN dept BETWEEN 1 AND 2 THEN 'Sci' ELSE 'Art' END FROM teacher;

/*10.Use CASE to show the name of each teacher followed by 'Sci' if the teacher is in dept 1 or 2, show 'Art' if the teacher's dept is 3 and 'None' otherwise.*/
SELECT name, CASE WHEN dept BETWEEN 1 AND 2 THEN 'Sci' WHEN dept BETWEEN 1 AND 2 THEN 'Art' ELSE 'None' END FROM teacher;
